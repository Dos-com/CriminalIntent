...
Emulator Open AVD(Android Virtual Device) manager -> Create Virtual Device-> Select Phone or Tablet -> next -> select Release Of System (Name of release R and Api 30) -> next -> finish. Next step. On Right Top of Android Studio select virtual device and run project.
